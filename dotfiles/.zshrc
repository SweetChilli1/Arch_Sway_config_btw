...
# export EDITOR=nvim
# export VISUAL=nvim
export LIBCLANG_PATH="/home/track/.rustup/toolchains/esp/xtensa-esp32-elf-clang/esp-19.1.2_20250225/esp-clang/lib"
export PATH="/home/track/.rustup/toolchains/esp/xtensa-esp-elf/esp-14.2.0_20240906/xtensa-esp-elf/bin:$PATH"
...
#	  --color=gutter:#16161e \
#	  --color=header:#ff9e64 \ 
#	  --pkg-config --libs --cflags webkit2gtk-4.1
#
#	  --color=hl+:#2ac3de \
#	  --color=hl:#2ac3de \
#	  --color=info:#545c7e \
